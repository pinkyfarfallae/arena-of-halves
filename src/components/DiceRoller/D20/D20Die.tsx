...
const D20Scene = lazy(lazyRetry(() => import('./D20Scene')));

const WINK_COUNT = 8;

export default function D20Die({ rolling, onResult, onRollEnd, onClick, fixedResult, themeColors }: DieRendererProps) {
