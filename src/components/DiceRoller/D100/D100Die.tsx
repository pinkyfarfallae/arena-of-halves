...
const D100Scene = lazy(lazyRetry(() => import('./D100Scene')));

const WINK_COUNT = 8;

export default function D100Die({ rolling, onResult, onRollEnd, onClick, fixedResult, themeColors }: DieRendererProps) {
