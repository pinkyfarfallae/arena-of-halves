...
const D10Scene = lazy(lazyRetry(() => import('./D10Scene')));

const WINK_COUNT = 8;

export default function D10Die({ rolling, onResult, onRollEnd, onClick, fixedResult, themeColors }: DieRendererProps) {
