...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  Hades: [
    ...
    },
    {
      ...
      skipDice: true,
      description:
        '/ * เข้าสถานะ "ผู้กลืนวิญญาณ" เป็นเวลา 3 รอบ โดยการโจมตีปกติ ไม่ว่าจะทอยโจมตีสำเร็จหรือไม่สำเร็จก็ตาม จะดูดกลืน HP ของศัตรูอย่างแน่นอนแน่นอน 1 หน่วย และนำมาฟื้นฟู HP ให้กับตนเอง โดยจะไม่สามารถป้องกันได้และนับเป็นการโจมตี  ซึ่งโครงกระดูกช่วยตีได้ / * เมื่อร่าย "Soul Eater" เป็นการจะร่าย "Undead Army" โดยทันที',
      available: true,
      effect: 'lifesteal',
      target: 'enemy',
      value: 1,
