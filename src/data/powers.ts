...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  [DEITY.APOLLO]: [
    ...
    },
    {
      ...
      description:
        'ทายาทแห่งอพอลโลจะเข้าสู่สถานะ “กระหน่ำยิง” เป็นระยะเวลา3 รอบ จากนั้นทำการโจมตีปกติทันที ในสถานะกระหน่ำยิงนี้ ทายาทแห่งอพอลโลจะมีความแม่นยำมากขึ้น โดยจะเป็นการ +3 แต้มเต๋าโจมตีและหากทำการโจมตีสำเร็จด้วยการทอยเต๋า ทายาทแห่งอพอลโลจะมีโอกาส 75% ที่จะโจมตีเสริม 1 ครั้ง โดยจะเกิดขึ้นเรื่อยๆ และโอกาสจะลดลง 25% ต่อการโจมตีเสริมที่เกิดขึ้น 1 ครั้ง (ลดลงไม่ต่ำไปกว่า 25%) จนกว่าจะสุ่มไม่ติด ทั้งนี้ การโจมตีเสริมจะทำดาเมจ 50% ของการโจมตีปกติและการโจมตีปกติในสถานะกระหน่ำยิงนี้สามารถติดคริได้ โดยคิดแยกทุกครั้งที่เกิดการโจมตีเสริม',
      available: true,
      effect: EFFECT_TYPES.BUFF,
      target: TARGET_TYPES.SELF,
      value: 3,
