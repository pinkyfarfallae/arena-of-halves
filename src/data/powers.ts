  ...
  Persephone: [
    {
      ...
      description:
        'ในเทิร์นโจมตี เมื่อทอยได้แต้มมากกว่า 10 ในเทิร์นต่อไปจะถูกปกคลุมด้วยกลีบดอกไม้ ส่งผลให้จะไม่รับสถานะผิดปกติจากสกิลอื่น ๆ 1 ครั้ง',
      available: true,
      effect: 'shield',
      target: 'self',
      value: 0,
    ...
    },
    {
      ...
      name: 'Floral Scented',
      description:
        'ชโลมกลิ่นดอกไม้ให้กับเพื่อน 1 คน ฟื้นฟู HP 2 หน่วย ให้เป้าหมายจากนั้นทอยโจมตีตามปกติ',
      available: true,
      effect: 'heal',
      target: 'self',
      value: 2,
    ...
    },
    {
      ...
      description:
        'ผลัดฤดูกาลในพื้นที่เล็กๆ ที่อยู่ ให้กลายเป็นฤดูที่ต้องการ 2 รอบ / * ฤดูร้อน : +2 แต้มเต๋าโจมตีให้กับเพื่อน 1 คน / * ฤดูใบไม้ร่วง : เพิ่ม HP สูงสุดให้กับทุกคนในทีม +2 / * ฤดูหนาว : +2 แต้มเต๋าป้องกันให้กับตนเอง / * ฤดูใบไม้ผลิ : การโจมตีปกติจะถูกเปลี่ยนเป็นการฮีลแทน 1 หน่วย',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 2,
    ...
    },
    {
      ...
      description:
        'มอบเมล็ดทับทิมให้กับเพื่อน 1 คน ทำให้เป้าหมายกลายเป็นร่างวิญญาณ 3 รอบ เมื่อเป้าหมายโจมตีสำเร็จ เธอจะช่วยโจมตีแจมด้วย',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 0,
