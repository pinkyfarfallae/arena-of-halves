...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  [DEITY.APOLLO]: [
    ...
    },
    {
      ...
      description:
        'ทายาทแห่งเทพอพอลโลเสียสละโอกาสในการโจมตีเพื่อขับขานบทเพลงรักษาให้กับตนเองและเพื่อนร่วมทีม 1 คนอันจะช่วยฟื้นฟู HP 2 หน่วยในเบื้องต้นและมอบอัตราคริติคอลให้กับทั้งคู่อีก 25% เป็นระยะเวลา 2 รอบ',
      available: true,
      effect: EFFECT_TYPES.HEAL,
