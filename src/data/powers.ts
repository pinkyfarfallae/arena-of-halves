  ...
  Hades: [
    {
      ...
      name: 'Reviving',
      description:
        '/ * เมื่อมีฝ่ายตนเองคนใดตายในการต่อสู้ สามารถชุบชีวิตขึ้นมาใหม่ได้ โดยเป้าหมายจะฟื้นชีพขึ้นมาโดย HP 50% ของเป้าหมายเอง / * สามารถร่ายชุบให้ตนเองได้ และมีโควต้า 1 ครั้งต่อการต่อสู้',
      available: true,
      effect: 'heal',
      target: 'self',
      value: 0,
    ...
    },
    {
      ...
      name: 'Life Consume',
      description:
        'ดูดกลืนวิญญาณของศัตรู 1 เป้าหมาย ดูดกลืน HP ของเป้าหมาย 1 หน่วย และนำมา HP นั้นมาฟื้นฟู HP ให้กับตนเอง โดยการดูดกลืน HP จะไม่สามารถป้องกันได้ นับเป็นการโจมตี โครงกระดูกช่วยตีได้',
      available: true,
      effect: 'lifesteal',
      target: 'enemy',
      value: 1,
    ...
    },
    {
      ...
      name: 'Undead Army',
      description:
        'เรียกโครงกระดูก 1 ตัวขึ้นบนสนาม เมื่อเราโจมตี โครงกระดูกจะทำดาเมจเพิ่ม 1 หน่วย เมื่อเราโดนโจมตี โครงกระดูกจะรับดาเมจแทนและหายไปทันที บนสนามมีโครงกระดูกได้มากสุด 2 ตัวในเวลาเดียวกัน',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 1,
    ...
    },
    {
      ...
      skipDice: true,
      description:
        '/ * เข้าสถานะ "ผู้กลืนวิญญาณ" เป็นเวลา 3 รอบ โดยการโจมตีปกติ ไม่ว่าจะทอยโจมตีสำเร็จหรือไม่สำเร็จก็ตาม จะดูดกลืน HP ของศัตรูอย่างแน่นอนแน่นอน 1 หน่วย และนำมาฟื้นฟู HP ให้กับตนเอง โดยจะไม่สามารถป้องกันได้และนับเป็นการโจมตี ซึ่งโครงกระดูกช่วยตีได้ / * เมื่อร่าย Soul Eater จะร่าย Undead Army ฟรีทันที',
      available: true,
      effect: 'lifesteal',
      target: 'enemy',
      value: 1,
  ...
  Persephone: [
    {
      ...
      description:
        'ในเทิร์นโจมตี เมื่อได้แต้มจากการทอยเต๋ามากกว่า 10 ร่างกายของทายาทแห่งเพอร์เซโฟนีจะถูกปกคลุมด้วยกลีบดอกไม้โปรยปราบ ส่งผลให้จะไม่รับสถานะผิดปกติจากสกิลอื่น ๆ เป็นระยะเวลา 1 เทิร์น',
      available: true,
      effect: 'shield',
      target: 'self',
      value: 0,
    ...
    },
    {
      deity: 'Persephone',
      type: '2nd Skill',
      name: 'Borrowed Season',
      description:
        'เสียสละโอกาสในการโจมตีเพื่อผลัดฤดูกาลในพื้นต่อสู้ให้กลายเป็นฤดูที่ต้องการ 2 รอบ / * ฤดูร้อน : +2 แต้มเต๋าโจมตีให้กับทุกคนในทีมและตัวเอง / * ฤดูใบไม้ร่วง : เพิ่ม HP สูงสุดให้กับทุกคนในทีม +2 / * ฤดูหนาว : +2 แต้มเต๋าป้องกันให้กับทุกคนในทีมและตัวเอง / * ฤดูใบไม้ผลิ : ฮีลทุกคนในทีมและตนเอง 1 หน่วยเมื่อจบเทิร์น',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 2,
    ...
    },
    {
      ...
      description:
        'มอบเมล็ดทับทิมให้กับเพื่อนร่วมทีม 1 คน ทำให้เป้าหมายกลายเป็นร่างวิญญาณ 3 รอบ เมื่อเป้าหมายโจมตีสำเร็จ ทายาทแห่งเพอร์เซโฟนีจะช่วยทำการโจมตีร่วมด้วย',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 0,
