...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  Persephone: [
    ...
    },
    {
      ...
      description:
        'ผลัดฤดูกาลในพื้นที่ให้กลายเป็นฤดูที่ต้องการเป็นระยะเวลา 2 เทิร์น / * ฤดูร้อน : +2 แต้มโจมตีให้กับเพื่อนร่วมทีม 1 คน / * ฤดูใบไม้ร่วง : เพิ่ม HP สูงสุดให้กับทุกคนในทีม +2 / * ฤดูหนาว : +2 แต้มป้องกันให้กับตนเอง / * ฤดูใบไม้ผลิ : การโจมตีปกติจะถูกเปลี่ยนเป็นการฮีลแทน 1 หน่วย',
      available: true,
      effect: 'buff',
      target: 'self',
      value: 2,
