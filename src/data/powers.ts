...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  [DEITY.HECATE]: [
    ...
    },
    {
      ...
      description:
        ...
        \n\* เวทราตรี : โจมตีศัตรู 1 เป้าหมาย ทำดาเมจ 100% ของดาเมจโจมตีปกติและขโมยแต้มสกิลของเป้าหมายมาให้ตนเอง 1 แต้ม\
  ...
  [DEITY.PERSEPHONE]: [
    ...
    },
    {
      ...
      description:
        'ทายาทแห่งเพอร์เซโฟนีเลือกมอบ "เมล็ดทับทิมแห่งปรโลก" ให้กับเพื่อนร่วมทีม 1 คน ทำให้เป้าหมายกลายเป็น "ร่างวิญญาณ์" \
    ...
    },
    {
      ...
      description:
        ...
        โดยแอคชันที่สุ่มได้จากการทอย D6 มีดังนี้\
         ...
         \n\* 5: มอบโบนัสบวกแต้มเต๋าทุกประเภทให้ตนเองและเพื่อนทุกคนเป็นจำนวนตามผลของเต๋า D4 ทันทีเป็นระยะเวลา 2 รอบ\
         \n\* 6: มอบโอกาสทอยใหม่ 2 ครั้งให้กับคนเองและพันธมิตรเป็นจำนวนคนตามผลของเต๋า D4',
      available: true,
      effect: EFFECT_TYPES.BUFF,
      target: TARGET_TYPES.SELF,
      value: 0,
  ...
  [DEITY.HEMERA]: [
    ...
    },
    {
      ...
      description:
        ...
        โดยมอบโล่ให้กับเป้าหมาย 1 หน่วย และเพิ่ม HP เท่ากับ 10% ของ Max HP ของทายาทแห่งฮีเมราให้กับเป้าหมายผู้สวมอาภรณ์\
