...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  Persephone: [
    ...
    },
    {
      ...
      description:
        'มอบเมล็ดทับทิมให้กับเพื่อนร่วมทีม 1 คน ทำให้เป้าหมายกลายเป็นร่างวิญญาณซึ่งมีโอกาส 50% ที่จะปฏิเสธดาเมจเป็นระยะเวลา 3 เทิร์น เมื่อเป้าหมายโจมตีสำเร็จ ทายาทแห่งเพอร์เซโฟนีจะช่วยทำการโจมตีร่วมด้วย อย่างไรก็ตาม หากไม่มีเพื่อนรวมทีมเหลือในสนามทายาทแห่งเพอร์เซโฟนีถึงจะสามารถมอบเมล็ดทับทิมให้ตัวเองได้',
      available: true,
      effect: 'buff',
      target: 'ally',
      value: 0,
