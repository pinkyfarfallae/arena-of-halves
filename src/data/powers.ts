...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  [DEITY.ZEUS]: [
    ...
    },
    {
      ...
      description:
        'ทายาทแห่งซุสเสียสละโอกาสในการโจมตีเพื่อเรียกอัสนีบาตผ่าศัตรู 1 ตัว ทำดาเมจ 3 หน่วยทันทีรวมถึงทำดาเมจโดนศัตรูคนอื่นรอบข้าง 2 คน ทำดาเมจ 2 หน่วยโดยไม่ต้องทอยเต่าอีกทั้งศัตรูจะไม่มีโอกาสในการป้องกัน ทั้งนี้ ศักตรูทั้งหมดที่ได้รับดาเมจจากการใช้พลังนี้จะติดสถานะช็อตเช่นกัน',
      available: true,
      effect: EFFECT_TYPES.DAMAGE,
      target: TARGET_TYPES.ENEMY,
      value: 3,
  ...
  [DEITY.APOLLO]: [
    {
      deity: DEITY.APOLLO,
      type: POWER_TYPES.PASSIVE,
      name: DEITY_POWER_NAMES.CHILD_OF_THE_SUN,
      description:
    ...
    },
    {
      deity: DEITY.APOLLO,
      type: POWER_TYPES.FIRST_SKILL,
      name: DEITY_POWER_NAMES.HEALING_HYMN,
      description:
    ...
    },
    {
      deity: DEITY.APOLLO,
      type: POWER_TYPES.SECOND_SKILL,
      name: DEITY_POWER_NAMES.ARCHERY_MASTER,
      description:
