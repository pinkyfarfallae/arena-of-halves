...
export const DEITY_POWERS: Record<string, PowerDefinition[]> = {
  ...
  [DEITY.HADES]: [
    ...
    },
    {
      ...
      description:
        '/ * เข้าสถานะ "ผู้กลืนวิญญาณ" เป็นเวลา 3 รอบ โดยใน 3 รอบนั้นการโจมตีปกติของทายาทแห่งฮาเดสจะเปลี่ยนเป็นการดูดกลืน HP ของเป้าหมายแทน โดยจะดูดกลืน 50% ของดาเมจที่สามารถทำได้มาฟื้นฟูเป็น HP ให้กับตนเอง ซึ่งเป้าหมายไม่สามารถใช้พลังใด ๆ ลดความเสียหายได้และไม่สามารถป้องกันได้ / * เมื่อร่าย "Soul Devourer" เป็นการจะร่าย "Undead Army" โดยทันที',
      available: true,
      effect: EFFECT_TYPES.BUFF,
      target: TARGET_TYPES.SELF,
      value: 0,
  ...
  [DEITY.PERSEPHONE]: [
    ...
    },
    {
      ...
      description:
        'ทายาทแห่งเพอร์เซโฟนีเลือกชโลมสุคนธ์แห่งบุษบาให้กับตนเองหรือเพื่อนร่วมทีม 1 คน เพื่อทำการฟื้นฟู HP จำนวนทั้งสิ้น 20% ของ HP สูงสุดของตนให้ผู้รับการฟื้นฟูคนดังกล่าว จากนั้นทำการโจมตีตามปกติ',
      available: true,
      effect: EFFECT_TYPES.HEAL,
      target: TARGET_TYPES.ALLY,
      value: 20,
    ...
    },
    {
      ...
      description:
        'เสียสละโอกาสในการโจมตีเพื่อผลัดฤดูกาลในพื้นต่อสู้ให้กลายเป็นฤดูที่ต้องการ 2 รอบ / * คิมหันตฤดู : +2 แต้มเต๋าโจมตีให้กับทุกคนในทีมและตัวเอง / * วสันตฤดู : เพิ่ม HP สูงสุดให้กับทุกคนในทีม +2 / * เหมันตฤดู : +2 แต้มเต๋าป้องกันให้กับทุกคนในทีมและตัวเอง / * สารทฤดู : ฮีลทุกคนในทีมและตนเอง 1 หน่วยเมื่อจบเทิร์นของแต่ละคน',
      available: true,
      effect: EFFECT_TYPES.BUFF,
      target: TARGET_TYPES.SELF,
      value: 2,
