  ...
  [DEITY.APHRODITE]: [
    {
      ...
      description:
        'เมื่อทายาทแห่งอะโฟรไดท์ทอยป้องกันไม่สำเร็จ จะสามารถเลือกไม่รับดาเมจนั้นได้ โดยพื้นฐานจะมีโควต้าในการเลือกไม่รับดาเมจเริ่มต้นที่ 0 ครั้ง และจะได้รับโควต้าเพิ่ม 1 ครั้ง เมื่อทอยป้องกันสำเร็จ ทั้งนี้ โควต้าการปฏิเสธดาเมจสะสมได้สูงสุด 1 ครั้งเท่านั้น',
      available: true,
      effect: EFFECT_TYPES.SHIELD,
      target: TARGET_TYPES.SELF,
      value: 0,
