...
export const DEFAULT_THEME: Theme25 = [
...
export const DEITY_THEMES: Record<string, Theme25> = {
  ...
  hera:        ['#d90036', '#1a1010', '#f5e8e8', '#4682b4', '#f5e8e8', '#1a1010', '#f5e8ea', '#8a886a', '#d4c070', '#b09038', '#88b0d4', '#f0eada', '#eeeaD4', '#2a2020', '#f5eaa0', '#1a1010', '#d90036', '#ffffff', '#907830', '#285a88', '#d90036', '#88b0d4', '#d90036', '#88b0d4', '#907830'],
  ...
  aphrodite:   ['#ff8af1', '#1a0b1a', '#f4eafc', '#b48adf', '#f4eafc', '#1a0b1a', '#fbf6ff', '#9b89a8', '#d8a8ba', '#6f36b0', '#e6dff9', '#efe8fb', '#f1e8f9', '#2a1028', '#f6defb', '#1a0b1a', '#8a50c8', '#ffffff', '#6b2f9a', '#7a4a88', '#8a50c8', '#e6dff9', '#8a50c8', '#e6dff9', '#8a2fb8'],
  ...
  morpheus:    ['#2e1a47', '#0b0613', '#e9e6f7', '#6a5acd', '#dcd6ff', '#120a24', '#f1efff', '#4b3b6b', '#7a6cff', '#3f2e5c', '#b9a7ff', '#e6e1ff', '#dcd8f5', '#1a1333', '#cfc7ff', '#0b0613', '#5a4fcf', '#ffffff', '#6f63ff', '#8a7fff', '#5a4fcf', '#c3b6ff', '#5a4fcf', '#c3b6ff', '#3b2f6a'],
  amphitrite:    ['#7cc3eb', '#0c1929', '#e8f1f5', '#5dbea3', '#e8f1f5', '#0c1929', '#e5f0f6', '#6e7a88', '#7bb3d0', '#1e6fa0', '#a0dcc8', '#dde9f0', '#e0eaf0', '#1c2939', '#c8e8f8', '#0c1929', '#2e8bc0', '#ffffff', '#185a88', '#388a70', '#2e8bc0', '#a0dcc8', '#2e8bc0', '#a0dcc8', '#185a88'],
};
